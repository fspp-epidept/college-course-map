...
Open decisions tracked as Linear issues (do not solve preemptively): quantization (EPI-33), build-time fetch vs first-run download (EPI-31, EPI-56), HF namespace for converted ONNX repos (EPI-26), code-signing certs (EPI-1), versioning/release tooling (EPI-2). See Linear (EPI) for status.
